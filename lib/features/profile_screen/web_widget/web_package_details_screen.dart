...
class WebPackageDetails extends StatefulWidget {
  final String title,
      description,
      skills,
      imageUrl,
  ...
  @override
  State<WebPackageDetails> createState() => _WebPackageDetailsState();
}

class _WebPackageDetailsState extends State<WebPackageDetails> {
